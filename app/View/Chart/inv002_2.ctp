...
<?= $this->Html->script('jqplot/jquery.jqplot/jqplot.canvasTextRenderer.min.js') ?>
<?= $this->Html->script('jqplot/jquery.jqplot/jqplot.canvasAxisLabelRenderer.min.js') ?>
